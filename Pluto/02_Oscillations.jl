...
begin
	@bind t0_2 Clock(0.1,true,false,61,false)
end
...
begin
	@bind t0_3 Clock(0.1,true,false,65,false)
end
...
# ╔═╡ b4f114c3-35eb-44da-b30b-9cf72554bf8a
"""
...
function plot_velocity(time,position,velocity,xmin,xmax;centerpos=2.5,voffset=0)
	...
	annotate!(pp,(position/centerpos,0.07,text("Position=$(round(position,digits=2))",14,:red,:left)))
	annotate!(pp,(position+velocity/2,-0.07,text("Velocity=$(round(velocity,digits=2))",14,:blue)))
...
# ╔═╡ 76c1a434-bc0d-42f7-b4e8-b438e79204e3
"""
...
begin
	...
	s04 = exp(im*t04)
	v04 = im*exp(im*t04)
	tlabel4 = "t=$(round(t04,digits=2))"
	pp4 = plot_complexplane(-3, 3, -2, 2; arrow_to=s04)
